...
sealed abstract class Code(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
  ...
  def isDoNotUseReservedForFutureExpansionUseDefaultInSwitchInstead: _root_.scala.Boolean = false
  def companion: _root_.scalapb.GeneratedEnumCompanion[Code] = org.tensorflow.framework.error_codes.Code
  final def asRecognized: _root_.scala.Option[org.tensorflow.framework.error_codes.Code.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[org.tensorflow.framework.error_codes.Code.Recognized])
}
...
object Code extends _root_.scalapb.GeneratedEnumCompanion[Code] {
  ...
  /** An extra enum entry to prevent people from writing code that
    ...
    */
  @SerialVersionUID(0L)
  case object DO_NOT_USE_RESERVED_FOR_FUTURE_EXPANSION_USE_DEFAULT_IN_SWITCH_INSTEAD_ extends Code(20) with Code.Recognized {
    val index = 17
    val name = "DO_NOT_USE_RESERVED_FOR_FUTURE_EXPANSION_USE_DEFAULT_IN_SWITCH_INSTEAD_"
    override def isDoNotUseReservedForFutureExpansionUseDefaultInSwitchInstead: _root_.scala.Boolean = true
  }
  ...
  lazy val values = scala.collection.immutable.Seq(OK, CANCELLED, UNKNOWN, INVALID_ARGUMENT, DEADLINE_EXCEEDED, NOT_FOUND, ALREADY_EXISTS, PERMISSION_DENIED, UNAUTHENTICATED, RESOURCE_EXHAUSTED, FAILED_PRECONDITION, ABORTED, OUT_OF_RANGE, UNIMPLEMENTED, INTERNAL, UNAVAILABLE, DATA_LOSS, DO_NOT_USE_RESERVED_FOR_FUTURE_EXPANSION_USE_DEFAULT_IN_SWITCH_INSTEAD_)
  def fromValue(__value: _root_.scala.Int): Code = __value match {
    ...
    case 20 => DO_NOT_USE_RESERVED_FOR_FUTURE_EXPANSION_USE_DEFAULT_IN_SWITCH_INSTEAD_
    case __other => Unrecognized(__other)
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = ErrorCodesProto.javaDescriptor.getEnumTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = ErrorCodesProto.scalaDescriptor.enums(0)
}